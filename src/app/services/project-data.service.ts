...
export class ProjectDataService {
  ...
  private divisions: Division[] = [
    ...
    { id: '5', name: 'Office of the Vice Governor', code: 'OPVG', dateCreated: new Date(), dateUpdated: new Date() },
    { id: '6', name: 'Provincial Engineer\'s Office', code: 'PEO', dateCreated: new Date(), dateUpdated: new Date() },
    { id: '7', name: 'Provincial Information Office', code: 'PIO', dateCreated: new Date(), dateUpdated: new Date() },
    { id: '8', name: 'Provincial Communications Office', code: 'PCO', dateCreated: new Date(), dateUpdated: new Date() },
    { id: '9', name: 'Provincial Planning and Development Office', code: 'PPDO', dateCreated: new Date(), dateUpdated: new Date() },
    { id: '10', name: 'Provincial Human Resource Management Office', code: 'PHRMO', dateCreated: new Date(), dateUpdated: new Date() },
    { id: '11', name: 'Provincial General Services Office', code: 'PGSO', dateCreated: new Date(), dateUpdated: new Date() },
  ];
